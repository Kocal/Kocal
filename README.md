...
- ![](./assets/pr-merged.svg) [[Composer][Cache] Fix declared dependencies and cache activation detection](https://github.com/symfony/reprise/pull/78) on [symfony/reprise](https://github.com/symfony/reprise) (1 day ago)
- ![](./assets/pr-merged.svg) [[TagRenderer] Dispatch a `RenderAssetTagEvent` before rendering each tag](https://github.com/symfony/reprise/pull/77) on [symfony/reprise](https://github.com/symfony/reprise) (1 day ago)
- ![](./assets/pr-merged.svg) [[Preload] Preload module script entries as modulepreload](https://github.com/symfony/reprise/pull/72) on [symfony/reprise](https://github.com/symfony/reprise) (3 days ago)
- ![](./assets/pr-merged.svg) [[Integrity] Fix missing `integrity` and `crossorigin` to preload `Link` headers](https://github.com/symfony/reprise/pull/70) on [symfony/reprise](https://github.com/symfony/reprise) (4 days ago)
- ![](./assets/pr-merged.svg) [[Tests][CI] Add end-to-end playground tests with Vitest and Playwright](https://github.com/symfony/reprise/pull/69) on [symfony/reprise](https://github.com/symfony/reprise) (5 days ago)
- ![](./assets/pr-merged.svg) [[Playground] Rebuild as a Reprise &#43; Symfony UX showcase](https://github.com/symfony/reprise/pull/68) on [symfony/reprise](https://github.com/symfony/reprise) (6 days ago)
- ![](./assets/pr-merged.svg) [[Vite] Skip pruned CSS-only chunks in preload and dynamic](https://github.com/symfony/reprise/pull/67) on [symfony/reprise](https://github.com/symfony/reprise) (6 days ago)
