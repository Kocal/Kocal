...
- ![](./assets/pr-closed.svg) [fix(readme): fix link to UnoCSS](https://github.com/chakra-ui/panda/pull/706) on [chakra-ui/panda](https://github.com/chakra-ui/panda) (2 days ago)
- ![](./assets/pr-open.svg) [fix(translator): generate unique constants name (fix #938)](https://github.com/symfony/ux/pull/945) on [symfony/ux](https://github.com/symfony/ux) (4 days ago)
- ![](./assets/pr-merged.svg) [fix: specify base to parseInt()](https://github.com/beerose/tsc-diagnostics-diff-action/pull/18) on [beerose/tsc-diagnostics-diff-action](https://github.com/beerose/tsc-diagnostics-diff-action) (4 weeks ago)
